...
const checks = [
  ['Hotfix engine version is 3.0.1', olympianVersion.includes("olympian-roles-3.0.1")],
...
console.log(JSON.stringify({ ok: true, checks: checks.length, version: '3.0.1' }, null, 2));
